...
import AllAd_pageNavigator from "../shopAd/AllAd_pageNavigator";
...
export default function ShopOne() {
    ...
    const loadShop = function () {
        ...
        fetch("http://localhost:3333/api"
            + "/shop?"
            + '&author_id=' + author_id//plusssssssssssssssssssss
            , {
            method: 'GET',
            headers: {
            ...
            .then(data =>{
                ...
                toast.success("Усі магазини")// Ваш магазин
                console.log(data)
                setShop(data)
            })
            .catch(err=>{
